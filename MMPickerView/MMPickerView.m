...
NSString * const MMvalueSize = @"320.0";
//double  MMsize = 320.0;
...
@property (nonatomic, assign) CGFloat sizeFrame;
...
-(void)initializePickerViewInView: (UIView *)view
  ...
  _sizeFrame = [options[MMvalueSize] floatValue];
  ...
  //  NSLog(@"AKAA ",_sizeFrame);
  //PickerView Container with top bar
  _pickerContainerView = [[UIView alloc] initWithFrame:CGRectMake(0.0, _pickerViewContainerView.bounds.size.height - 260.0, _sizeFrame, 260.0)];
    
   // [MMPickerView setFrame: CGRectMake(xPoint, 50.0f, pickerWidth, 200.0f)];
